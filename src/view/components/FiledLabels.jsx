const fieldLabels = {
    english: {
      districtNumber: "Total Jila sam Mahanagar/ Bhag",
      districtNumberJilaKendra: "Total Jila Kendra",
      districtNumberAnyaNagar: "Total Any Nagar",
      settlementNumber: "Number of Sewa Basti within",
      serviceSettlementNumber: "Number of Sewa basti having sewa karya",
      businessCollegeNumber: "Number of Vyavsayee & Mahavidyalay shaka & Milan",
      settlementBranchNumber: "Number of Sevabasti Palak Shakha & Millan",
      serviceWorkerBranchNumber: "Number of Shakha & Milan having Sewa Karyakarta",
      totalServiceWorkers: "Total Sewa Karyakarta",
      totalServiceWork: "Total sewa karya in Mahanagar(Including sewa karya of Sewa Sanstha)",
      totalServiceWorkJilaKendra: "Total sewa karya in JilaKendra(Including sewa karya of Sewa Sanstha)",
      totalServiceWorkAnyaNagar: "Total sewa karya in AnyaNagar(Including sewa karya of Sewa Sanstha)",

      monthlyContactNumber: "Number of Shakha performing Masik Sewa Basti Sampark",
      villagesAbove5000: "Villages with Population greater than 5000",
      businessVillageNumber: "Number of Grams having Vyavsayee or Farmer Shakha",
      serviceVillageNumber: "Number of Seva Karya yukt gram",
      totalServiceInVillages: "Total Sewa Karya",
      villagesOver5000: "Number of Gram with population above 5000",
      villagesUnder5000: " Number of Gram with Population less than 5000",
      villagesUnderess5000:"Number of Sevakarya yukt gram",
    ...
    hindi: {
      ...
      districtNumberJilaKendra: "कुल जिला केन्द्र ",
      districtNumberAnyaNagar: "कुल अन्य नगर",
      ...
      totalServiceWorkJilaKendra: "जिला में कुल सेवा कार्य (सेवा संस्थाओं के सेवा कार्य सहित)",
      totalServiceWorkAnyaNagar: "अन्य नगर में कुल सेवा कार्य (सेवा संस्थाओं के सेवा कार्य सहित)",
      ...
      villagesUnderess5000:"5000 से कम जनसंख्या के सेवा युक्त ग्राम संख्या",
